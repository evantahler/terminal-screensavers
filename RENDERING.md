...
Screensavers already using `renderSparseRow()`: boids, bubbles, fireworks, flying-toasters, gravity-wells, lightning, mandelbrot-zoom, mystify, perlin-noise-field, ripples, sand-simulation, starfield, tunnel.
