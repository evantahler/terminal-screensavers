...
Screensavers already using `renderSparseRow()`: boids, bubbles, fireworks, flying-toasters, gravity-wells, lightning, mandelbrot-zoom, mystify, ripples, sand-simulation, starfield, tunnel.
